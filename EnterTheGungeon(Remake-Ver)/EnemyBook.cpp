...
void EnemyBook::init(FPOINT scale, const POINT& sp, POINT size, POINT currPos, POINT currIdx)
{
	Monster::init();
	_scale = move(scale);
	_size = move(size);
...
void EnemyBook::update()
{
	Monster::update();
	_weapon.update();
}

void EnemyBook::render(const HDC& hdc) const
{
	Monster::render(hdc);
	_weapon.render(hdc);
}

void EnemyBook::release()
{
	Monster::release();
}

void EnemyBook::changeIdleMotion(const MONSTER_STANDING_POSITION_STATE& selectedStandingState, bool isReverseX)
{
}

void EnemyBook::changeWalkingMotion(const MONSTER_STANDING_POSITION_STATE& selectedStandingState, bool isReverseX)
{
}

void EnemyBook::changeDeathMotion(const MONSTER_STANDING_POSITION_STATE& selectedStandingState, bool isReverseX)
{
}

void EnemyBook::changeAttackMotion(const MONSTER_STANDING_POSITION_STATE& selectedStandingState, bool isReverseX)
{
}
